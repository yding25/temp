...
class MoveGroupInteface(object):
	...
	def __init__(self):
		...
		self.move_group_commander.set_goal_position_tolerance(0.05)
		self.move_group_commander.set_goal_orientation_tolerance(0.05)
	...
	def plan_joint_goal_degree(self, joint0, joint1, joint2, joint3, joint4, joint5):
		# ------------------------------
		# set joint goal
		# ------------------------------
		joint_goal = self.move_group_commander.get_current_joint_values()
		joint_goal[0] = joint0 / 180.0 * 3.1415926
		joint_goal[1] = joint1 / 180.0 * 3.1415926
		joint_goal[2] = joint2 / 180.0 * 3.1415926
		joint_goal[3] = joint3 / 180.0 * 3.1415926
		joint_goal[4] = joint4 / 180.0 * 3.1415926
		joint_goal[5] = joint5 / 180.0 * 3.1415926
		'''
		The go command can be called with joint values, poses, or without any
		parameters if you have already set the pose or joint target for the group
		'''
	...
	def execute_plan(self, plan):
		...
		'''
		# Wait for the current motion to finish before generating a new trajectory
		rospy.sleep(1.0)
