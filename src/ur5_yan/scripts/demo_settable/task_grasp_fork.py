...
demo.plan_joint_goal_degree(-7.56, -52.73, 28.13, -94.02, -89.96, 0)
...
x_init = -position[0] - 0.12
# y_init = -position[1] - 0.25 
y_init = -position[1] - 0.26
z_init = position[2]
...
# rotate
# -----------------------------------------
demo.plan_joint_goal_degree(-30.74, -59.48, 84.45, -116.08, -76.60, 63.26)
...
demo.plan_joint_goal_degree(-29.30, -63.51, 79.01, -111.18, -86.38, 44.99)
